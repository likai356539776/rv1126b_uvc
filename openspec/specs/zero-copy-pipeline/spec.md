# Zero-Copy Pipeline Specification

## Purpose
The purpose of this specification is to define the zero-copy video processing pipeline requirements, including multi-channel VPSS output, DMA-Buf video frame passing, RKNN NPU zero-copy inference, and RGA hardware-accelerated cropping and compositing.
